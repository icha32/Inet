        ...
        <section class="content">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              Daily Sales:
              <input id="dailySale" type="date" class="btn btn-default btn-sm" value="<?= date('Y-m-d'); ?>"> &nbsp; &nbsp; Sampai &nbsp; &nbsp;
              <input id="dailySale2" type="date" class="btn btn-default btn-sm" value="<?= date('Y-m-d'); ?>" disabled>
