...
class Laundry extends Database implements iLaundry {
	...
	public function new_laundry($customer, $priority, $weight, $type, $types, $paket, $pengambilan)
	{
		$sql = "INSERT INTO laundry(customer_name, laun_priority, laun_weight, laun_type_id, laun_types, laun_paket, laun_pengambilan)
				VALUES(?,?,?,?,?,?,?);";
		return $this->insertRow($sql, [$customer, $priority, $weight, $type, $types, $paket, $pengambilan]);
	}//end new_laundry
	...
	public function edit_laundry($laun_id, $customer, $priority, $weight, $type, $types, $pengambilan)
	{
		$sql = "UPDATE laundry 
				SET customer_name = ?, laun_priority = ?, laun_weight = ?, laun_type_id = ?, laun_types = ?, laun_pengambilan = ?
				WHERE laun_id = ?";
		return $this->updateRow($sql, [$customer, $priority, $weight, $type, $types, $pengambilan, $laun_id]);
	}//end edit_laundry
